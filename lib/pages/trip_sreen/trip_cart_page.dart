...
import 'package:plantrip_traveler/pages/trip_sreen/trip_place_detail.dart';
import 'package:shared_preferences/shared_preferences.dart';

class TripCartPage extends StatefulWidget {
  const TripCartPage({super.key});

  @override
  State<TripCartPage> createState() => _TripCartPageState();
}
...
Set<String> cartPlaceId = Set();

class _TripCartPageState extends State<TripCartPage> {
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => TripPlaceDetail(),
                  settings: RouteSettings(arguments: cartPlaceId)),
            );
          },
